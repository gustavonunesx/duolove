  ...
  return (
    <div className="mt-2">
      ...
      <p className="mt-1 text-xs text-[#8b8b9e]">
        Força: <span className="text-[#f5f0eb]">{labels[strength - 1] ?? "Muito fraca"}</span>
      </p>
    </div>
  );
}
      ...
      <div className="rounded-2xl border border-white/8 bg-[#1a1a2e]/60 p-8 backdrop-blur-xl">
        ...
        <div className="mb-7">
          ...
          <p className="text-sm text-[#8b8b9e]">
            Crie sua conta grátis e convide seu amor.
          </p>
        </div>
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <span className="text-xs text-[#8b8b9e]">ou crie com email</span>
          <div className="flex-1 border-t border-white/8" />
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-11 text-sm text-[#f5f0eb] placeholder-[#8b8b9e]/60 outline-none transition-all focus:border-[#e91e8c]/60 focus:ring-2 focus:ring-[#e91e8c]/20"
